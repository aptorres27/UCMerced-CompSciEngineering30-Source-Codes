...
BTree::~BTree() //delete the binary tree by calling destory_tree()
{
	destroy_tree();
}

Node *BTree::BTree_root() //return to the root of the tree
{
	return root; 
}
...
{
	if(leaf != NULL){ 			//To delete the tree, you have to go left and right nodes of the leaf to  delete
